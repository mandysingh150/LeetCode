...
<pre><strong>Input:</strong> <span class="highlighter--deleted" data-highlight-id="1" style="background-color: inherit; color: inherit;">people = [3,2,2,1], limit = 3</span>
<strong>Output:</strong> 3
<strong>Explanation:</strong> 3 boats (1<span class="highlighter--deleted" data-highlight-id="0" style="background-color: inherit; color: inherit;">, 2), (2) and (3)</span>
</pre>
